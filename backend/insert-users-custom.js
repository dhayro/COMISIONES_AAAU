...
/**
 * Script para insertar usuarios con contraseñas específicas
...
async function insertarUsuarios() {
  let connection;
  try {
    console.log('\n🔄 Insertando usuarios con contraseñas específicas...\n');
    ...
    console.log(`║ Email: dhayro.kong@hotmail.com        ║`);
    console.log(`║ Pass: (la contraseña hash está lista)  ║`);
    console.log(`╚════════════════════════════════════════╝\n`);
