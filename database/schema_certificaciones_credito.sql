...
COMMENT ON TABLE certificaciones_credito IS 'Almacena las certificaciones de crédito presupuestario principales con información general';
COMMENT ON TABLE detalles_certificacion_credito IS 'Almacena los detalles de cada certificación incluyendo clasificadores y montos asociados';
